...
const StaticIP = (/* props */) => {
  ...
  const {
    number: defaultGateway1,
    setNumber: updateDefaultGateway1,
  } = useNumber();
  const {
    number: defaultGateway2,
    setNumber: updateDefaultGateway2,
  } = useNumber();
  const {
    number: defaultGateway3,
    setNumber: updateDefaultGateway3,
  } = useNumber();
  const {
    number: defaultGateway4,
    setNumber: updateDefaultGateway4,
  } = useNumber();
  ...
  const validateData = () => {
    ...
    // }
    if (
      !Number.isInteger(defaultGateway1) ||
      defaultGateway1 < 0 ||
      defaultGateway1 > 255
    ) {
      flag--;
    ...
    if (
      !Number.isInteger(defaultGateway2) ||
      defaultGateway2 < 0 ||
      defaultGateway2 > 255
    ) {
      flag--;
    ...
    if (
      !Number.isInteger(defaultGateway3) ||
      defaultGateway3 < 0 ||
      defaultGateway3 > 255
    ) {
      flag--;
    ...
    if (
      !Number.isInteger(defaultGateway4) ||
      defaultGateway4 < 0 ||
      defaultGateway4 > 255
    ) {
      flag--;
  ...
  return (
    <Fragment>
      {updateSent === true && updateSucsess === false && (
        <h2>Error Updating IP Data</h2>
      )}
      ...
      <form onSubmit={onSubmit}>
        <p>
          ...
          <input
            ...
            value={ip1}
            onInput={(e) => {
              updateIp1(e.target.value); /* onValChange(e)*/
            }}
          />
          <input
            type="number"
            ...
            value={ip2}
            onInput={(e) => {
              updateIp2(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
          <input
            type="number"
            ...
            value={ip3}
            onInput={(e) => {
              updateIp3(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
          <input
            type="number"
            ...
            value={ip4}
            onInput={(e) => {
              updateIp4(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
        </p>
        <p>
          ...
          <input
            ...
            value={subnetMask1}
            onInput={(e) => {
              updateSubnetMask1(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
          <input
            type="number"
            ...
            value={subnetMask2}
            onInput={(e) => {
              updateSubnetMask2(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
          <input
            type="number"
            ...
            value={subnetMask3}
            onInput={(e) => {
              updateSubnetMask3(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
          <input
            type="number"
            ...
            value={subnetMask4}
            onInput={(e) => {
              updateSubnetMask4(e.target.value); /*onValChange(e.target.value)*/
            }}
          />
        </p>
        <p>
